...
class EmailService{
    ...
    public function send(Lead $lead): void //Отправить уведомление на почту
    {
        Mail::to($this->_settings->email_to_address)->send(new NewLead($lead));
    } //send
