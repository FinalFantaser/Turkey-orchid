<section id="catalog" class="section catalog">
    <div class="catalog__container container">
        ...
        <div class="catalog__buttons">
            <p class="catalog__buttons__elem catalog__buttons__elem--active">Купить квартиру</p>
            <p class="catalog__buttons__elem">Снять квартиру</p>
        </div>

        <a href="directory.html" class="catalog__link">
